...
outfile = 'output/img_cmt_bart.ra';
if exist(outfile) == 0
  tstart = tic;
...
subplot(121); imagesc(X, [a,0.9*b]); colormap(gray); axis image; axis off;
set(gca,'FontSize',14);
title('whole body');
text(10,20,'IRT','Color','w');
text(256+10,20,'gpuNUFFT','Color','w');
% text(1024+10,20,'BART','Color','white');
% text(1024+512+10,20,'TRON','Color','white');
text(10,256,'BART','Color','w');
text(256+10,256,'TRON','Color','w');
