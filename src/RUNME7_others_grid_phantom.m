...
rawrite(img_irt, 'output/img_laph_irt.ra');
...
img_gn = sqrt(img_gn);
rawrite(img_gn, 'output/img_laph_gn.ra');
...
rawrite(img_bart,'output/img_laph_bart.ra');
...
title('reconstructed linear-angle phantom');
